...
const gambar = 'https://telegra.ph/file/ecac94e418534db656dd0.jpg'
...
sendButVideo(from, Teks, `*©Haikal | ©DhaniGanss Official Api*`, buffer, [                      
{
...
buffer = await getBuffer(`https://apidhani.herokuapp.com/api/randomvideo/${command}?apikey=NisaaCantik`)
Teks = `Klik Buttonnya Kak ${pushname} Untuk Story Selanjutnya`
sendButVideo(from, Teks, `*©Haikal | ©DhaniGanss Official Api*`, buffer, [                      
